...
| Doors matched | 6/308 (recall 0.02) |
...
| 2026-06-10 (door + crop tuning) | Door detect: merged collinear span gaps, wider axis clustering, crop-specific gap band (1.25–5.5 ft) and ink tolerance; `_gap_is_open` max_ink_frac param. Crop Hough min 2.5 ft; skip synthetic DPI warning on `crop_mode`; 4 ft opening match tolerance on crops. LabelMe doors 6/308 (fp_60 +5); median wall cov R flat at 0.55; synth doors 1.0/1.0. |
